...
//func RestyPostForm(filename string, filePath string, data interface{}, url string) (httpStatus int, body []byte, err error) {
...
//		SetHeaders(headers).
//		R().
//		SetFileReader("file", filename, bytes.NewReader(fileb)).
